...
namespace RatioMusic.Application.Services
{
    ...
    {        
        ...
        public ArtistService(IBaseRepository<Artist> artistRepository, IMapper mapper)
        {
        ...
        {
            int ArtistId = await _artistRepository.CreateAsync(_mapper.Map<Artist>(newArtistRequest));
        ...
        {
            var res = await _artistRepository.UpdateAsync(_mapper.Map<Artist>(Artist));
